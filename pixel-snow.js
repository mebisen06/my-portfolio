class PixelSnow {
    constructor(container, options = {}) {
        ...
        // Theme-based defaults matching Cyber Gold and dark theme
    ...
    init() {
        const { THREE } = window;
        if (!THREE) {
            console.error('Three.js is required for PixelSnow');
            return;
        }
        ...
        let variantValue = 0.0;
        if (this.options.variant === 'round') variantValue = 1.0;
        else if (this.options.variant === 'snowflake') variantValue = 2.0;
